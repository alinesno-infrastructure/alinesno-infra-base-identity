...
/**
 * 处理与WhiteAccountEntity相关的请求的Controller。
 * 继承自BaseController类并实现IWhiteAccountService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class WhiteAccountController extends BaseController<WhiteAccountEntity, IWhiteAccountService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(WhiteAccountController.class);

    @Autowired
    private IWhiteAccountService service;

    /**
     * 获取WhiteAccountEntity的DataTables数据。
     *
    ...
    @Override
    public IWhiteAccountService getFeign() {
        return this.service;
    }
}
